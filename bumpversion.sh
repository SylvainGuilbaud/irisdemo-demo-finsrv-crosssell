...
if [ -f VERSION ]; then
    ...
    # will be let alone.
    #
    sed -E -i '' "s;(intersystemsdc/irisdemo-demo-finsrv-crosssell:.+)-version-[0-9][0-9.]*;\1-version-$INPUT_STRING;g" ./docker-compose.yml
    sed -E -i '' "s;(intersystemsdc/irisdemo-demo-finsrv-crosssell:.+)-version-[0-9][0-9.]*;\1-version-$INPUT_STRING;g" ./banking_trn_srv/Dockerfile
